...
export default function Page() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-600 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-8 py-24 min-h-screen">
      {/* Header Section */}
      <div className="text-center mb-16">
        <p className="text-white dark:text-gray-300 opacity-90 mb-10 text-lg max-w-3xl mx-auto">
      ...
      {/* Mission Section */}
      <Card className="max-w-3xl mx-auto p-8 bg-white dark:bg-gray-800 shadow-xl rounded-xl transform transition duration-300 hover:scale-105 hover:shadow-2xl mb-16">
        <h3 className="text-center mb-6 text-3xl font-semibold text-gray-800 dark:text-gray-100">
          បេសកកម្មរបស់យើង
        </h3>
      ...
      <div className="flex justify-center mb-16">
        <Button className="bg-white dark:bg-gray-800 text-blue-600 dark:text-white py-3 px-8 rounded-lg text-lg font-semibold transform transition duration-300 hover:scale-105 hover:bg-blue-100 dark:hover:bg-gray-700 hover:text-blue-800 dark:hover:text-white">
      ...
      <div className="mt-24">
        <div className="text-center mb-12">
          <h3 className="text-white dark:text-gray-100 text-4xl mb-6 font-semibold">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-12">
          {/* Create Blog Section */}
          <Card className="w-80 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-center text-2xl mb-6 font-semibold text-gray-800 dark:text-gray-100">
              បង្កើតអត្ថបទប្លក់
            </h3>
      ...
      {/* Call to Action */}
      <div className="text-center mt-16 mb-16">
        <h3 className="text-white dark:text-gray-100 text-3xl mb-4 font-semibold">
          ចូលរួមជាមួយយើង!
        </h3>
        <Button className="bg-white dark:bg-gray-800 text-blue-600 dark:text-white py-3 px-8 rounded-lg text-lg font-semibold transform transition duration-300 hover:scale-105 hover:bg-blue-100 dark:hover:bg-gray-700 hover:text-blue-800 dark:hover:text-white">
          ចាប់ផ្តើមឥឡូវនេះ
